...
const newsItems = [
  {
    ...
    excerpt: "Launched my personal website built with Next.js 14 and deployed on Cloudflare Pages.",
    date: "2024-01-20",
  ...
  },
  {
    ...
    excerpt: "Presented on 'Building Scalable Web Applications with TypeScript' at Tokyo Tech Conference.",
    date: "2024-01-18",
  ...
  },
  {
    ...
    excerpt: "Contributed to the Next.js documentation with improvements to the internationalization guide.",
    date: "2024-01-12",
